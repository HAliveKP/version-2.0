...
class AuthRoutes:
    ...
    def home(self):
        products = [
            {"name": "Product 1", "description": "High-quality product with excellent features", "price": "$29.99"},
            {"name": "Product 2", "description": "Premium solution for professional use", "price": "$49.99"},
            {"name": "Product 3", "description": "Budget-friendly option without compromises", "price": "$19.99"},
            {"name": "Product 4", "description": "Advanced features for power users", "price": "$79.99"},
        ]
